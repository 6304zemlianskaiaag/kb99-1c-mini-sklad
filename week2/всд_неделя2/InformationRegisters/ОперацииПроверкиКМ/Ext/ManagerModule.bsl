...
Процедура ДобавитьРезультатыОтправкиЕГАИС(ПараметрыЗаписи) Экспорт
	...
	Для Каждого ШтрихкодыПродукции Из ПараметрыЗаписи.ШтрихкодыПродукции Цикл
		...
		РазобранныйШтрхкод = МенеджерОборудованияМаркировкаКлиентСервер.РазобратьШтриховойКодТовара(КодМаркировкиBase64, Истина);
		
		ЭтоПродукцияЕГАИС = РазобранныйШтрхкод.ТипИдентификатораТовара = Перечисления.ТипыИдентификаторовТовараККТ.КодТовараВФорматеЕГАИС2
			Или РазобранныйШтрхкод.ТипИдентификатораТовара = Перечисления.ТипыИдентификаторовТовараККТ.КодТовараВФорматеЕГАИС3;

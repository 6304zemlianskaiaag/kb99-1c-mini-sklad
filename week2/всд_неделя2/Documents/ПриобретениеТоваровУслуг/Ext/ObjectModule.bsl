...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, СтандартнаяОбработка)
	...
	ДокументОснование = ЗакупкиСервер.ДокументОснование(ЭтотОбъект, "ПоступлениеПоЗаказам, ЗаказПоставщику, Товары.ЗаказПоставщику");
...
Процедура ЗаполнитьАналитикамиСУчетомСерий()
	...
	ПакетнаяОбработкаТабличнойЧастиСервер.ОбработатьТЧ(ТаблицаВидыЗапасов, СтруктураДействий, Неопределено);

...
Функция СкорректироватьСтрокиЗаказа(СтруктураПараметров) Экспорт
	...
	Запрос.УстановитьПараметр(
		...
		ВозвращаемыеТовары.Выгрузить(
			...
			"НомерСтроки, КодСтроки, Номенклатура, Склад, Характеристика, Упаковка,
...
Процедура ПриКопировании(ОбъектКопирования)
	...
	Для Каждого СтрокаТЧ Из ВозвращаемыеТовары Цикл
		...
		Если Не ВозвратПорчи И СтрокаТЧ.Порча Тогда
			СтрокаТЧ.Порча = Ложь;
			СтрокаТЧ.НоменклатураОприходование = Справочники.Номенклатура.ПустаяСсылка();
			СтрокаТЧ.ХарактеристикаОприходование = Справочники.ХарактеристикиНоменклатуры.ПустаяСсылка();
		КонецЕсли;
...
Функция ТекстЗапросаПоЗаявкамНаВозвратТоваровОтКлиентов()
	...
	|		ЗаявкаНаВозвратТоваровОтКлиента = &ЗаявкаНаВозвратТоваровОтКлиента
	|		И КодСтроки <> 0) КАК ТоварыКПоступлению
	...
	|			ЗаявкаНаВозвратТоваровОтКлиента = &ЗаявкаНаВозвратТоваровОтКлиента
	|			И КодСтроки <> 0) КАК Остатки
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.ЗаявкаНаВозвратТоваровОтКлиента.ВозвращаемыеТовары КАК ЗаявкаНаВозвратТоваровОтКлиентаВозвращаемыеТовары
	|			ПО Остатки.ЗаявкаНаВозвратТоваровОтКлиента = ЗаявкаНаВозвратТоваровОтКлиентаВозвращаемыеТовары.Ссылка

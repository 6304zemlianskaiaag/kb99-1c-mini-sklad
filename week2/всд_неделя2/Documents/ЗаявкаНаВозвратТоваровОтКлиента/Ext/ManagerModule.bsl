...
Функция ТекстЗапросаТаблицаЗаявкиНаВозвратТоваровОтКлиентов(Запрос, ТекстыЗапроса, Регистры)
	...
	ТекстЗапроса =
		...
		|	ТаблицаВозвращаемыеТовары.Склад                    КАК Склад
		|ИЗ
...
Процедура ДобавитьТекстыОтраженияВзаиморасчетов(Запрос, ТекстыЗапроса, Регистры)
	...
	ВзаиморасчетыСервер.ПроведениеВозвратаТоваровОтКлиента(Запрос, ТекстыЗапроса, Регистры, ТекстВозврат); 
...
Процедура Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "ЗаявкаНаВозврат") Тогда
		...
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(
			...
			"ЗаявкаНаВозврат",
			НСтр("ru = 'Заявка на возврат (выводить скидки)'"),
	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "ЗаявкаНаВозвратБезСкидок") Тогда
		...
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(
			...
			НСтр("ru = 'Заявка на возврат (не выводить скидки)'"),
			СформироватьПечатнуюФормуЗаявкиНаВозврат(МассивОбъектов, ОбъектыПечати, ПараметрыПечати, ПараметрыВывода.КодЯзыка),,
			"Документ.ЗаявкаНаВозвратТоваровОтКлиента.ПФ_MXL_ЗаявкаНаВозврат");
...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Процедура = "Документы.ЗаявкаНаВозвратТоваровОтКлиента.ЗаполнитьСкладВТабличнойЧастиДокумента";
	Обработчик.Версия = "11.5.21.60";
	Обработчик.РежимВыполнения = "Отложенно";
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("7c65356a-d18b-46f1-a0df-bdda8e9e2844");
	Обработчик.Многопоточный = Истина;
	Обработчик.ПроцедураЗаполненияДанныхОбновления = "Документы.ЗаявкаНаВозвратТоваровОтКлиента.ЗарегистрироватьДанныеКОбработкеЗаполнитьСкладВТабличнойЧастиДокумента";
	Обработчик.ПроцедураПроверки = "ОбновлениеИнформационнойБазы.ДанныеОбновленыНаНовуюВерсиюПрограммы";
	Обработчик.Порядок = Перечисления.ПорядокОбработчиковОбновления.Обычный;
	Обработчик.Комментарий = НСтр("ru = 'Заполняет реквизит ""Склад"" в табличных частях ""Возвращаемые товары"" и ""Заменяющие товары"".'");
...
Процедура ЗарегистрироватьДанныеКОбработкеЗаполнитьСкладВТабличнойЧастиДокумента(Параметры) Экспорт
	...
	ПараметрыВыборки.ПолныеИменаОбъектов = "Документ.ЗаявкаНаВозвратТоваровОтКлиента";
	...
	|		ПО ЗаявкаНаВозвратТоваровОтКлиентаВозвращаемыеТовары.Ссылка = ЗаявкаНаВозвратТоваровОтКлиента.Ссылка
	|ГДЕ
	|	ЗаявкаНаВозвратТоваровОтКлиентаВозвращаемыеТовары.Склад = ЗНАЧЕНИЕ(Справочник.Склады.ПустаяСсылка)
	|	И ЗаявкаНаВозвратТоваровОтКлиента.Склад <> ЗНАЧЕНИЕ(Справочник.Склады.ПустаяСсылка)
	|	И НЕ ЗаявкаНаВозвратТоваровОтКлиента.Склад.ЭтоГруппа
	|
	|ОБЪЕДИНИТЬ
	|
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
	|	ЗаявкаНаВозвратТоваровОтКлиентаЗаменяющиеТовары.Ссылка
	|ИЗ
	|	Документ.ЗаявкаНаВозвратТоваровОтКлиента.ЗаменяющиеТовары КАК ЗаявкаНаВозвратТоваровОтКлиентаЗаменяющиеТовары
	|		ЛЕВОЕ СОЕДИНЕНИЕ Документ.ЗаявкаНаВозвратТоваровОтКлиента КАК ЗаявкаНаВозвратТоваровОтКлиента
	|		ПО ЗаявкаНаВозвратТоваровОтКлиентаЗаменяющиеТовары.Ссылка = ЗаявкаНаВозвратТоваровОтКлиента.Ссылка
	|ГДЕ
	|	ЗаявкаНаВозвратТоваровОтКлиентаЗаменяющиеТовары.Склад = ЗНАЧЕНИЕ(Справочник.Склады.ПустаяСсылка)
	|	И ЗаявкаНаВозвратТоваровОтКлиента.Склад <> ЗНАЧЕНИЕ(Справочник.Склады.ПустаяСсылка)
	|	И НЕ ЗаявкаНаВозвратТоваровОтКлиента.Склад.ЭтоГруппа";
...
Процедура ЗаполнитьСкладВТабличнойЧастиДокумента(Параметры) Экспорт
	...
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.ЗаявкаНаВозвратТоваровОтКлиента КАК ДанныеДокумента
	...
	Пока Выборка.Следующий() Цикл
		...
		Попытка
			...
			ЗаполнитьРеквизитВКоллекции(ДокументОбъект.ВозвращаемыеТовары, "Склад", ДокументОбъект.Склад);
			ЗаполнитьРеквизитВКоллекции(ДокументОбъект.ВозвращаемыеСерии,  "Склад", ДокументОбъект.Склад);
			ЗаполнитьРеквизитВКоллекции(ДокументОбъект.ЗаменяющиеТовары,   "Склад", ДокументОбъект.Склад);

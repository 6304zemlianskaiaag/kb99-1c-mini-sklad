...
Процедура УстановитьДоступностьЭлементовРМКЛокализация(Форма, ДоступныеВидыОплаты)
	...
	Если Форма.ОбщаяСуммаОплатыСБП > 0 ИЛИ Форма.ОбщаяСуммаОплатыЭСФСС > 0 
...
Процедура ИнформационнаяПанельЛокализация(Форма, ИнформацияОбОплате)
	...
	Если СуммаПоВидуОплатыСБП > 0 Тогда
		...
		ОбщаяСуммаОплатыПлатежнымиКартамиИСБП = Форма.ИнформационнаяПанельСуммаКВозвратуПлатежнымиКартами + СуммаПоВидуОплатыСБП;

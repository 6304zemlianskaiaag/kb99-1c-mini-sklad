...
Процедура ДобавитьТекстыОтраженияВзаиморасчетов(Запрос, ТекстыЗапроса, Регистры)
	...
	ВзаиморасчетыСервер.ПроведениеВозвратаТоваровОтКлиента(Запрос, ТекстыЗапроса, Регистры, ТекстВозврат, ТекстРасшифровкаПлатежа);
...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Процедура = "Документы.ВозвратТоваровОтКлиента.ЗаполнитьСкладВТабличнойЧастиДокумента";
	Обработчик.Версия = "11.5.21.60";
	Обработчик.РежимВыполнения = "Отложенно";
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("0bdc9a8a-f088-4410-b9ec-44f641a258f6");
	Обработчик.Многопоточный = Истина;
	Обработчик.ПроцедураЗаполненияДанныхОбновления = "Документы.ВозвратТоваровОтКлиента.ЗарегистрироватьДанныеКОбработкеЗаполнитьСкладВТабличнойЧастиДокумента";
...
Процедура ЗарегистрироватьДанныеКОбработкеЗаполнитьСкладВТабличнойЧастиДокумента(Параметры) Экспорт
	...
	|ГДЕ
	|	ВозвратТоваровОтКлиентаТовары.Склад = ЗНАЧЕНИЕ(Справочник.Склады.ПустаяСсылка)
	|	И ВозвратТоваровОтКлиента.Склад <> ЗНАЧЕНИЕ(Справочник.Склады.ПустаяСсылка)
	|	И НЕ ВозвратТоваровОтКлиента.Склад.ЭтоГруппа";

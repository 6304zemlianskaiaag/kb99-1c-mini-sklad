...
Процедура ОбработатьШтрихкоды(ДанныеШтрихкодов)
	...
	СтруктураДействийСДобавленнымиСтроками.Вставить("ЗаполнитьСтавкуНДС", ПакетнаяОбработкаТабличнойЧастиКлиентСервер.ПараметрыЗаполненияСтавкиНДС(Объект, Истина));
...
Процедура ДобавитьДействиеЗаполненияЦен(СтруктураДействий)
	...
	Иначе
		...
		Если ПараметрыДоговора.ПоНовойКомиссии И ЗначениеЗаполнено(ПараметрыДоговора.УчетныйВидЦены) Тогда
			...
			ПараметрыПроверкиВидаЦены = Новый Структура();
			ПараметрыПроверкиВидаЦены.Вставить("ИспользоватьПриПродаже", Истина);
			ПараметрыПроверкиВидаЦены.Вставить("Статус", ПредопределенноеЗначение("Перечисление.СтатусыДействияВидовЦен.Действует"));
			
			ПараметрыДействия = Новый Структура();
			ПараметрыДействия.Вставить("ВидЦены", ПараметрыДоговора.УчетныйВидЦены);
			ПараметрыДействия.Вставить("ПараметрыОтбора", ПараметрыПроверкиВидаЦены);

			СтруктураДействий.Вставить("ПроверитьЗаполнитьВидЦены", ПараметрыДействия);

...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ОбменСКонтрагентамиПереопределяемый.ПриПроверкиГотовностиЭлектронногоДокумента(ТолькоПросмотр);
...
Процедура МК_НастроитьЭлементыФормы()
	...
	ИнтерфейсМобильногоЭДО.УстановитьОбщиеСвойстваФормы(ЭтотОбъект);

...
Функция ТекстЗапросаТаблицаДвиженияДенежныеСредстваКонтрагент(Запрос, ТекстыЗапроса, Регистры)
	...
	Если НЕ ПроведениеДокументов.ЕстьТаблицаЗапроса("ВтСуммаПлатежнымиКартамиВРазрезеСтатейДДС",,Запрос.МенеджерВременныхТаблиц) Тогда
	...
	Если НЕ ПроведениеДокументов.ЕстьТаблицаЗапроса("ВтСуммыНДСВРазрезеСтатейДДС", , Запрос.МенеджерВременныхТаблиц) Тогда

...
Процедура ПриЧтенииНаСервере(ТекущийОбъект)
	...
	УстановитьПризнакиКэшированияИзображенийСтрок(Объект.Товары, ИспользоватьСервисРаботаСНоменклатурой);	
...
&НаКлиентеНаСервереБезКонтекста
Процедура УстановитьПризнакиКэшированияИзображенийСтрок(Товары, ИспользоватьСервисРаботаСНоменклатурой)
...
Процедура УстановитьПризнакКэшированияИзображенияСтроки(СтрокаТаблицыТоваров, ИспользоватьСервисРаботаСНоменклатурой)
	...
	Если ЗначениеЗаполнено(СтрокаТаблицыТоваров.Номенклатура) Тогда
		...
		СтрокаТаблицыТоваров.КэшироватьВыбранноеИзображение = СтрокаТаблицыТоваров.ИсточникДобавленияТовара = 0 
			И Не НоменклатураСопоставлена(СтрокаТаблицыТоваров.Номенклатура, ИспользоватьСервисРаботаСНоменклатурой);
...
Процедура ОткрытьФормуВыбораСправочникаНоменклатура()
	...
	ОткрытьФорму(ИмяФормыВыбораНоменклатуры, , ЭтотОбъект, , , , ОписаниеОповещения);
...
&НаСервереБезКонтекста
Функция НоменклатураСопоставлена(Номенклатура, ИспользоватьСервисРаботаСНоменклатурой)
	
	Результат = Ложь;

	Если ОбщегоНазначения.ПодсистемаСуществует("ЭлектронноеВзаимодействие.РаботаСНоменклатурой") 
...
Процедура ПриИзмененииИзображения(ТекущиеДанные)
	...
	Если ТекущиеДанные.КэшироватьВыбранноеИзображение Тогда
		...
		ЗаполнитьЗначенияСвойств(СтрокаИзмененныхЗначений, ТекущиеДанные, "Номенклатура, Характеристика, Изображение");

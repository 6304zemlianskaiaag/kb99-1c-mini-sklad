...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, СтандартнаяОбработка)
	...
	// Отпустил, ОтпустилДолжность заполняем по статистике, после заполнения Менеджера
	...
	ЗаполнениеОбъектовПоСтатистике.ЗаполнитьРеквизитыОбъекта(ЭтотОбъект, ДанныеЗаполнения, ОписаниеРеквизитов);

...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЭтоОблачныйЭДО = ЭтоУчетнаяЗаписьОблачногоЭДОПоИдентификаторуОтправителя(ИдентификаторОтправителя);
...
Процедура ПринятьПриглашение()
	...
	Если ЗначениеЗаполнено(ПриглашениеНаИдентификатор.КлючПриглашения) Тогда
		...
		ВходящееПриглашение.ЭтоОблачныйЭДО = ЭтоОблачныйЭДО;
...
Процедура ОбновитьДанныеПриглашенияКонтрагента(Форма, ПараметрыПриглашения = Неопределено)
	...
	Если ЗначениеЗаполнено(ПараметрыПриглашения.ИдентификаторОрганизации) Тогда
		...
		Форма.ЭтоОблачныйЭДО = ЭтоУчетнаяЗаписьОблачногоЭДОПоИдентификаторуОтправителя(Форма.ИдентификаторОтправителя);
	КонецЕсли;
...
&НаСервереБезКонтекста
Функция ЭтоУчетнаяЗаписьОблачногоЭДОПоИдентификаторуОтправителя(ИдентификаторОтправителя)

	Если Не ЗначениеЗаполнено(ИдентификаторОтправителя) Тогда
		Возврат Ложь;
	КонецЕсли;
	
	Возврат УчетныеЗаписиЭДО.ЭтоУчетнаяЗаписьОблачногоЭДО(ИдентификаторОтправителя);

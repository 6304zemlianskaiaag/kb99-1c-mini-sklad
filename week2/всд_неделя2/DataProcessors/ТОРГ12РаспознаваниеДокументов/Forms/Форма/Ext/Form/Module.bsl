...
Процедура Подключаемый_ОбработкаВыбораПоля(Элемент, ВыбранноеЗначение, СтандартнаяОбработка)
	...
	ДополнительныеДанные.Вставить("ПараметрыВыбораНоменклатуры", МассивПараметровВыбораНоменклатуры());
...
Процедура ПриИзмененииНоменклатуры(ИдентификаторСтроки)
	...
	ТекущиеДанные.ТПодразделение = РаспознаваниеДокументовСлужебныйКлиентСервер.ЗначениеРеквизитаДокумента(Объект, "Подразделение",

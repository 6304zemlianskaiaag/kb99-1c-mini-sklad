...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ЭтоМобильныйКлиент Тогда
		ИнтерфейсМобильногоЭДО.НастроитьЭлементыФормыТекущиеДелаЭДОЛегкийИнтерфейс(ЭтотОбъект);
	КонецЕсли;
...
Процедура ПанельНавигацииДокументСформирован(Элемент)
	...
	ИначеЕсли ТекущийРаздел = "СоздатьНовый" Тогда 
		ОчиститьКнопки(Элемент.Документ);
		Элемент.Документ.getElementById("create-button").classList.add("checked");
...
Процедура УстановитьПараметрыСписков()
	...
	Контейнеры.Параметры.УстановитьЗначениеПараметра("ОтображатьУдаленные", ОтображатьУдаленные);
...
Процедура НастроитьПанельОтветственного(ДанныеКомпонента)
	...
	Элементы.ГруппаПанельОтветственного.Видимость = 
...
Процедура ОчиститьКнопки(Документ)
	...
	Документ.getElementById("create-button").classList.remove("checked");
...
Процедура МК_ОбновитьЗаголовкиПереключателейСтраниц()
	...
	ИнтерфейсМобильногоЭДО.ОбновитьЗаголовкиПереключателейСтраницФормыТекущиеДелаЭДОЛегкийИнтерфейс(

...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ТолькоПросмотр = Не кб99_ВСД_Параметры.ЭтоПолноправныйПользователь();
...
Процедура ГородПриИзменении(Элемент)
	...
	Если Не кб99_ВСД_Утилиты.ПроверитьВладельцаСправочника(Объект.Город, Владелец_) Тогда
		Объект.Город = Неопределено;
	КонецЕсли;
...
Процедура УлицаПриИзменении(Элемент)
	...
	Если Не кб99_ВСД_Утилиты.ПроверитьВладельцаСправочника(Объект.Улица, Владелец_) Тогда
		Объект.Улица = Неопределено;
	КонецЕсли;
...
Процедура кнПолучитьОтветВетисНаСервере()
	...
	ПараметрыФункции.Вставить("ApplicationID", кб99_ВСД_Утилиты.НайтиApplicationID(ВыбранныйДокумент));

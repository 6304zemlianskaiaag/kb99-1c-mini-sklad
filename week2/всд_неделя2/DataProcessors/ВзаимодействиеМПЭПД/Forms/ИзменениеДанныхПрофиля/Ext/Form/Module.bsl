...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	|СНИЛС, СерияВУ, НомерВУ, ДатаВыдачиВУ, Фамилия, ФизическоеЛицо, Роль, ВидыДокументов";
	...
	Если ЭтапЦикла = "ЗакрытьФорму" Тогда
		Если ОжиданиеРезультата.Статус = "Выполнено" Тогда
			...
			Иначе
				...
				СтруктураПолей.Вставить("СерияВУ", СерияВУ);
				СтруктураПолей.Вставить("НомерВУ", НомерВУ);
				СтруктураПолей.Вставить("ДатаВыдачиВУ", ДатаВыдачиВУ);

...
Процедура ВыполнитьЗадачуПервая(Команда)
	...
	Если СтрокаЗадачи.ПроцессТип = "DMBusinessProcessInvitation"
			И РезультатID = "ПринятоОбязательнымиУчастниками" Тогда //@NON-NLS-1 @NON-NLS-2
	...
	Если ПроцессТип = "DMBusinessProcessConsideration" И ТочкаМаршрута = "Рассмотреть" Тогда //@NON-NLS-1 @NON-NLS-2
	...
	ИначеЕсли ПроцессТип = "DMBusinessProcessIssuesSolution" И ТочкаМаршрута = "РассмотрениеИнициатором"
			И ВидВопросаID = "Иное" Тогда //@NON-NLS-1 @NON-NLS-2 @NON-NLS-3
		ТребоватьРезультатВыполнения = Истина;
	КонецЕсли;
	...
	Если ПроцессТип = "DMBusinessProcessInvitation" И ТочкаМаршрута = "Ознакомиться"
			И (РезультатID = "НеПринятоОбязательнымиУчастниками"
				Или РезультатID = "НеПринятоВсемиУчастниками") Тогда //@NON-NLS-1 @NON-NLS-2 @NON-NLS-3 @NON-NLS-4
...
Процедура ВыполнитьЗадачуВторая(Команда)
	...
	ИначеЕсли ПроцессТип = "DMBusinessProcessInvitation" И ТочкаМаршрута = "Ознакомиться"
			И РезультатID = "ПринятоОбязательнымиУчастниками" Тогда //@NON-NLS-1 @NON-NLS-2 @NON-NLS-3
...
Процедура ВыполнитьЗадачуТретья(Команда)
	...
	// Требует ли тип задачи ввода результата выполнения?
	Если ПроцессТип = "DMBusinessProcessApproval" И ТочкаМаршрута = "Согласовать" Тогда //@NON-NLS-1 @NON-NLS-2
		ТребоватьРезультатВыполнения = Истина;
	КонецЕсли;
	...
	ИначеЕсли ИмяТипа = "DMBusinessProcessApprovalTaskApproval" Тогда
		...
		Если НомерКнопки = 1 Тогда
			...
			Ответ.objectID = ИнтеграцияС1СДокументооборотБазоваяФункциональность.СоздатьObjectID(
				Прокси,
				"Согласовано",
				"DMApprovalResult"); //@NON-NLS-1 @NON-NLS-2
	...
	ИначеЕсли ИмяТипа = "DMBusinessProcessConfirmationTaskConfirmation" Тогда
		...
		Если НомерКнопки = 1 Тогда
			...
			Ответ.objectID = ИнтеграцияС1СДокументооборотБазоваяФункциональность.СоздатьObjectID(
				Прокси,
				"Утверждено",
				"DMConfirmationResult"); //@NON-NLS-1 @NON-NLS-2
		ИначеЕсли НомерКнопки = 2 Тогда
	...
	ИначеЕсли ИмяТипа = "DMBusinessProcessRegistrationTaskRegistration" Тогда
		...
		Если НомерКнопки = 1 Тогда
			...
			Ответ.objectID = ИнтеграцияС1СДокументооборотБазоваяФункциональность.СоздатьObjectID(
				Прокси,
				"Зарегистрировано",
				"DMRegistrationResult"); //@NON-NLS-1 @NON-NLS-2
		ИначеЕсли НомерКнопки = 2 Тогда
	...
	ИначеЕсли ИмяТипа = "DMBusinessProcessInvitationTaskInvitation" Тогда
		...
		Если НомерКнопки = 1 Тогда
			...
			Ответ.objectID = ИнтеграцияС1СДокументооборотБазоваяФункциональность.СоздатьObjectID(
				Прокси,
				"Принято",
				"DMInvitationResult"); //@NON-NLS-1 @NON-NLS-2
		ИначеЕсли НомерКнопки = 2 Тогда

...
&НаКлиенте
Процедура ПредставлениеДокументаВБазеНажатие(Элемент)
...
Процедура ЗагрузитьДокумент(Команда)
	...
	ПодключитьОбработчикОжидания("Подключаемый_ЗагрузитьДокумент", 0.1, Истина);
...
&НаКлиенте
Процедура Подключаемый_ЗагрузитьДокумент()
...
Процедура УстановитьВидимостьРезультатаПоиска(Знач ЕстьОшибка = Ложь, Знач ТекстПричиныОшибки = "")
	...
	Если ЗначениеЗаполнено(СсылкаНаОбъектУчета) Тогда
		...
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "НайтиДокумент", "КнопкаПоУмолчанию",
			Истина);
	...
	Иначе
		...
		Иначе
			Если ДоступКДокументуЗакрыт Или ДокументНеНайден Тогда
				ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "СтраницыКоманд",
					"ТекущаяСтраница", Элементы.СтраницаНайти);
				ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "НайтиДокумент",

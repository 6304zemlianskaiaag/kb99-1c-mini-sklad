...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не Параметры.Свойство("Партия", Партия) Тогда
		Отказ = Истина;
	КонецЕсли;
...
//
Функция УстановитьПараметр(Настройки, Параметр, Значение, Использование = Истина, Недоступный = Ложь)
...
Процедура СформироватьОтчетНаСервере()
	...
	УстановитьПараметр(КомпоновщикНастроек, "Партия", Партия, Истина);

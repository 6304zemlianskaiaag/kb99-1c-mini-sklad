...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	Если ТребуетсяВыводЛегенды Тогда
		Макет = УправлениеПечатью.МакетПечатнойФормы("Отчет.ОтчетСервисПрогнозированияСлужебный.Легенда");
	...
	КлючеваяОперация = "Отчет.ОтчетСервисПрогнозированияСлужебный.МодульОбъекта.ПриКомпоновкеРезультата";

...
Процедура ЗаполнитьСпискиВыбораАдресовПолучателяОтправителя(ЭлементыФормы, ДокОбъект) Экспорт
	...
	Если ЗначениеЗаполнено(Грузополучатель) Тогда
		...
		АдресаГрузополучателя = АдресаДоставкиИзКонтактнойИнфомации(АдресаГрузополучателя);
	...
	ПоследниеРеквизитыДоставкиИзРаспоряжений =
		ПоследниеРеквизитыДоставкиИзРаспоряжений(ДокОбъект.Ссылка, ПолучательОтправитель,, Грузополучатель);
	ДополнитьСписокВыбораИзТаблицыАдресов(СписокВыбора, ПоследниеРеквизитыДоставкиИзРаспоряжений, НСтр("ru = 'По статистике'"));
	...
	Если ЗначениеЗаполнено(Контрагент) Тогда
		...
		АдресаКонтрагента = АдресаДоставкиИзКонтактнойИнфомации(АдресаКонтрагента);
...
//  
Функция АдресаДоставкиИзКонтактнойИнфомации(КонтактнаяИнформация)

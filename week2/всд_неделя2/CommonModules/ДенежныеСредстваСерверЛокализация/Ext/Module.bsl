...
Процедура ПроверитьЗаполнениеБанковскихРеквизитов(Объект, Отказ, ВалютныйСчет) Экспорт
	...
	ИначеЕсли ЗначениеЗаполнено(Объект.Банк) Тогда
		...
		ДанныеБанка = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(Объект.Банк, "Код, СВИФТБИК, Наименование, КоррСчет, Город");
	...
	ИначеЕсли ЗначениеЗаполнено(Объект.БанкДляРасчетов) Тогда
		...
		ДанныеБанка = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(Объект.БанкДляРасчетов, "Код, СВИФТБИК, Наименование, КоррСчет, Город, КодСтраны");

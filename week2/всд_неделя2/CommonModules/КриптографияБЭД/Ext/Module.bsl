...
Функция ТекстШтампаЭП(ДанныеДляФормирования, Подписи, ТекстШтампа)
	...
	Для Каждого Подпись Из Подписи Цикл
		...
		ТекстЭП.ДобавитьСтроку(МакетЭП.ПолучитьСтроку(25));
	...
	ТекстЭП.ДобавитьСтроку(МакетЭП.ПолучитьСтроку(31));
	...
	СтрокаЭП = МакетЭП.ПолучитьСтроку(33);
	...
	ТекстЭП.ДобавитьСтроку(МакетЭП.ПолучитьСтроку(35));

...
Процедура ПодключитьСистемуБыстрыхПлатежей(
	...
	НастройкиПодключения.Вставить(
		"ВариантНастройки",
		ПараметрыПодключенияПроверка.ВариантНастройки);
...
//
// Параметры:
//  ВладелецФормы - ФормаКлиентскогоПриложения -  ы качестве владельца может выступить форма или элемент
...
// Открывает форму выбора настройки подключения к Системой быстрых платежей.
//
// Параметры:
//  Владелец - ФормаКлиентскогоПриложения - форма которая будет установлена в качестве владельца;
//  ОписаниеОповещения - ОписаниеОповещения, Неопределено - оповещение, которое
...
//    c2b - подключение приема оплат от физических лиц;
//    b2b - подключение приема оплат от юридических лиц.
//  Отбор - Структура, Неопределено - параметра отбора списка.
//
Процедура ВыбратьНастройку(
	...
	Если Отбор <> Неопределено Тогда
		ПараметрыФормы.Вставить("Отбор", Отбор);
	КонецЕсли;
	ПараметрыФормы.Вставить("ВариантНастройки", ВариантНастройки);
	
	ОткрытьФорму(
		"Справочник.НастройкиПодключенияКСистемеБыстрыхПлатежей.Форма.ФормаВыбора",
		ПараметрыФормы,
		Владелец,
		,
		,
...
// Открывает форму настройки отображения команд с Системой быстрых платежей.
//
// Параметры:
//  Владелец - ФормаКлиентскогоПриложения - форма которая будет установлена в качестве владельца.
//
Процедура НастройкаОтображенияКоманд(Владелец) Экспорт
	...
	ОткрытьФорму(
		"ОбщаяФорма.НастройкаОтображенияКомандСБП",
		,
		Владелец);

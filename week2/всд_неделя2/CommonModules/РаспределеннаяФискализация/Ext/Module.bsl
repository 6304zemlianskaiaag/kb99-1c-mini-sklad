...
//
// Возвращаемое значение:
//   ПериодХранения - ПеречислениеСсылка.ПериодХраненияИсторииОпераций
...
Процедура УстановитьСрокХраненияОперацийОчередиЧеков() Экспорт 
	...
	Если НЕ ЗначениеЗаполнено(Константы.СрокХраненияОперацийОчередиЧеков.Получить()) Тогда
		Константы.СрокХраненияОперацийОчередиЧеков.Установить(Перечисления.ПериодХраненияИсторииОпераций.ВсеВремя);
	КонецЕсли;

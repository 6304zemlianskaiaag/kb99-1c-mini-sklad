...
// Параметры:
//  КонтектДиагностики - см. ОбработкаНеисправностейБЭД.НовыйКонтекстДиагностики
//  ИдентификаторУчетнойЗаписи - Строка
Процедура ОткрытьФормуУчетнойЗаписи(КонтектДиагностики, ИдентификаторУчетнойЗаписи) Экспорт

...
Функция КодПланируемыйСтатусМаркируемогоТовара(ПланируемыйСтатусМаркируемогоТовара) Экспорт
	...
	Соответствие = Перечисления.ПланируемыйСтатусМаркируемогоТовара.КодыПланируемыхСтатусовМаркируемогоТовара();
...
Функция КодОтветаОИСМОСтатусеТовара(ОтветОИСМОСтатусеТовара) Экспорт
	...
	Соответствие = Перечисления.ОтветОИСМОСтатусеТовара.КодыОтветаОИСМОСтатусеТовара();
...
Функция ОтветОИСМОСтатусеТовараПоКоду(ОтветОИСМОСтатусеТовара) Экспорт
	...
	Соответствие = Перечисления.ОтветОИСМОСтатусеТовара.ОтветыОИСМОСтатусеТовараПоКоду();
	Возврат Соответствие.Получить(ОтветОИСМОСтатусеТовара);
...
Процедура ЗаполнитьОтраслевойРеквизитВетеринарныеПрепараты(Позиция) Экспорт
	...
	Если ТипыТоваров.ВетеринарныеПрепараты Тогда        
		// Заполнение отраслевого реквизита для ветеринарныых препаратов при передаче рецепта.
		ОтраслевойРеквизит.ИдентификаторФОИВ = "030"; // 1262 

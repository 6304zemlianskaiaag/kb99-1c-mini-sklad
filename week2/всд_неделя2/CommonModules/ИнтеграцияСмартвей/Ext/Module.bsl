...
Процедура ПолучитьДанныеБронирования() Экспорт
	...
	ОтветСервиса = ВыполнитьЗапросКСервису(
		НастройкиПодключения, ЗапросНовыеДанныеБронирования(ВерсияДанныхСмартвей.Получить()), Истина);
...
Процедура ЗаписатьОбъект(ОбъектДляЗаписи)
	...
	Исключение
		...
		ТекстСообщенияПользователю = СтрШаблон(ТекстОшибки, ТекстСообщения, ОписаниеОшибки.Причина.Причина.Описание);

...
Процедура ИсправитьПроблемыВДвиженияхИДокументах(ПараметрыРасчета)
	...
	|	ОБЪЕДИНИТЬ ВСЕ
	|
	// В регистре "Отклонения в стоимости товаров" не должно быть движений с видом запасов "Собственный товар по неотфактурованной поставке".
	// Стоимости с таким видом запасов должны отражаться в регистре "Себестоимость товаров".
	|	ВЫБРАТЬ РАЗЛИЧНЫЕ
	|		""ОтклоненияВСтоимостиТоваров"",
	|		Т.Регистратор,
	|		Т.Организация,
	...
	|		И НЕ Т.РасчетПартий
	|		И НЕ Т.РасчетСебестоимости
	|		И Т.ВидЗапасов.ТипЗапасов = ЗНАЧЕНИЕ(Перечисление.ТипыЗапасов.СобственныйТоварПоНеотфактурованнойПоставке)
	|
	|	ОБЪЕДИНИТЬ ВСЕ
	|	
	...
	РасшифровкаКодовОшибок.Вставить(86, НСтр("ru='Не корректно отражена стоимость фактуровки поставки в регистре ""Отклонения в стоимости товаро"".'", ОбщегоНазначения.КодОсновногоЯзыка()));
	РасшифровкаКодовОшибок.Вставить(87, НСтр("ru='Заполнены различные коды строк в аналитике учета партии приходного документа при одинаковых аналитиках в строках документа'", ОбщегоНазначения.КодОсновногоЯзыка()));	
	...
	РасшифровкаКодовОшибок.Вставить(91, НСтр("ru='Не заполнен реквизит ""Документ движения"" в движениях отчета давальцу между организациями.'"));	
	...
	РасшифровкаКодовОшибок.Вставить(2,
		НСтр("ru = 'Отличаются суммы в движения по регистру ""Закупки"" от регистров ""Себестоимость товаров"" и ""Отклонения в стоимости товаров""'",
			ОбщегоНазначения.КодОсновногоЯзыка()));

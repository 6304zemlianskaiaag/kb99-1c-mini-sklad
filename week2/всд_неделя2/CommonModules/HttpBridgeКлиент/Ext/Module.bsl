...
Асинх Функция PutАсинх(URL, Тело, Заголовки = Неопределено) Экспорт
	...
	Попытка
		СтрокаОтвет = "";
		РезультатВызова = Ждать ОбъектДрайвера.PutАсинх(НастрокаПодключенияJSON, ЗаголовкиJSON, Тело, СтрокаОтвет); // РезультатАсинхВызоваВнешнейКомпоненты
		РезультатОперации = РезультатОперации();
...
Асинх Функция GetАсинх(URL, Заголовки = Неопределено) Экспорт
	...
	Попытка
		СтрокаОтвет = "";
		РезультатВызова = Ждать ОбъектДрайвера.GetАсинх(НастрокаПодключенияJSON, ЗаголовкиJSON, СтрокаОтвет); // РезультатАсинхВызоваВнешнейКомпоненты
		РезультатОперации = РезультатОперации();
		РезультатОперации.КодОтвета = РезультатВызова.Значение;
		РезультатОперации.Ответ = РезультатВызова.Параметры[2];
		УстановитьЗаголовки(РезультатОперации.Заголовки, РезультатВызова.Параметры[1]);
...
Асинх Функция PostАсинх(URL, Тело, Заголовки = Неопределено) Экспорт
	...
	Попытка
		СтрокаОтвет = "";
		РезультатВызова = Ждать ОбъектДрайвера.PostАсинх(НастрокаПодключенияJSON, ЗаголовкиJSON, Тело, СтрокаОтвет); // РезультатАсинхВызоваВнешнейКомпоненты
		РезультатОперации = РезультатОперации();
		РезультатОперации.КодОтвета = РезультатВызова.Значение;
...
Асинх Функция DeleteАсинх(URL, Заголовки = Неопределено) Экспорт
	...
	Попытка
		СтрокаОтвет = "";
		РезультатВызова = Ждать ОбъектДрайвера.DeleteАсинх(НастрокаПодключенияJSON, ЗаголовкиJSON, СтрокаОтвет); // РезультатАсинхВызоваВнешнейКомпоненты
		РезультатОперации = РезультатОперации();
		РезультатОперации.КодОтвета = РезультатВызова.Значение;
		РезультатОперации.Ответ = РезультатВызова.Параметры[2];    
		УстановитьЗаголовки(РезультатОперации.Заголовки, РезультатВызова.Параметры[1]);

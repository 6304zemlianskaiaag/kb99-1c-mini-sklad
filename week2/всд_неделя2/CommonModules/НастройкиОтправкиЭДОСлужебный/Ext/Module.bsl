...
Функция НастройкиОтправки(КлючНастроекОтправки) Экспорт
	...
	Если ЕстьНастройкаПоКлючу И ЕстьНастройкаПоВидуДокумента Тогда
		...
		Если ТребуетсяОбновлениеФорматовИСвязейВидовФорматов(ПоддерживаемыеФорматы, ФорматыЭлектронныхДокументов) Тогда
			ОбновитьФорматыИСвязьВидовФорматовИзСервисаНастроек();
		КонецЕсли;
				
		ТребуетсяОбновлениеФормата = ТребуетсяОбновленияФорматаВНастройкахОтправки(ПоддерживаемыеФорматы,
			ПолучаемаяНастройка.Формат, ПолучаемаяНастройка.ВерсияФорматаУстановленаВручную,
			ФорматыЭлектронныхДокументов);
			
		ЭтоУПД = ПолучаемаяНастройка.Формат = ПоддерживаемыеФорматы.УПД2019.ИнформацияПродавца
			Или ПолучаемаяНастройка.Формат = ПоддерживаемыеФорматы.УПД_5_02.ИнформацияПродавца
			Или ПолучаемаяНастройка.Формат = ПоддерживаемыеФорматы.УПД_5_03.ИнформацияПродавца;
		Если ЭтоУПД И ЕстьНастройкиЗаполненияДополнительныхПолей
			И Не ЕстьНастройкиЗаполненияДополнительныхПолейВНовомФормате Тогда
			ТребуетсяПереносНастроекЗаполненияДополнительныхПолей = Истина;
		КонецЕсли;
	КонецЕсли;
	
	Если ТребуетсяОбновлениеФормата Тогда
		ОбновитьВерсиюФорматаВНастройкахОтправки(ПолучаемаяНастройка, ФорматыЭлектронныхДокументов);
...
// Возвращаемое значение:
//  Булево
Функция ТребуетсяОбновлениеФорматовИСвязейВидовФорматов(ПоддерживаемыеФорматы,
	ФорматыЭлектронныхДокументов = Неопределено)
...
Процедура ОбновитьФорматыИСвязьВидовФорматовИзСервисаНастроек() Экспорт
	...
	ИдентификаторыФорматовДляОбновления.Добавить("ON_CHETOP_1_998_01_05_01_01");
	ИдентификаторыФорматовДляОбновления.Добавить("ПроизвольныйXML");
	КонвертацияЭДО.ОбновитьПравилаПреобразованияФорматовИзСервисаПринудительно(ИдентификаторыФорматовДляОбновления);
...
// Возвращаемое значение:
//  Булево
Функция ТребуетсяОбновленияФорматаВНастройкахОтправки(ПоддерживаемыеФорматы, ТекущийФормат,
	ВерсияФорматаУстановленаВручную, ФорматыЭлектронныхДокументов = Неопределено)
...
//  ФорматыЭлектронныхДокументов - Неопределено
//                               - См. ЭлектронныеДокументыЭДО.ФорматыЭлектронныхДокументов
Процедура ОбновитьВерсиюФорматаВНастройкахОтправки(ТекущаяНастройка, ФорматыЭлектронныхДокументов = Неопределено)

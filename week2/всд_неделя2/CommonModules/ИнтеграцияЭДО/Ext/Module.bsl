...
Функция ОрганизацияПоКлючевымРеквизитам(КлючевыеРеквизитыОрганизации) Экспорт
...
Функция ОтветственныйВходящегоДокументаЭДО(Организация, Контрагент, Договор) Экспорт
	...
	Если АвтоматическоеПолучениеЭДОПовтИсп.ИспользоватьПолучениеИзСервисаЭДО() Тогда
...
//  * ИНН - Строка
//  * КПП - Строка
Функция УчастникиЭДОПоКлючевымРеквизитам(КлючиУчастниковЭДО, ТипУчастниковЭДО) Экспорт
...
Функция ПредставлениеРегиона(Наименование, ТипРегиона, КодРегиона)
	...
	Если КодРегиона = "99" Тогда
		Возврат "иные территории, включая город и космодром Байконур";

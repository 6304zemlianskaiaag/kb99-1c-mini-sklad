...
// Подбирает изображение из системы согласно обозначенному алгоритму:
// 1. Получение сохраненного значения из нового регистра сведений ИзображенияЗапросовКоммерческихПредложений.
// Если сохраненное значение имеется, второй шаг пропускается
// 2. Получение изображения из переопределяемой процедуры 
// 	КоммерческиеПредложенияПереопределяемый.ПодобратьИзображенияДляПубликацииВЗКП,
// которая возвращает таблицу значений с изображениями, подобранными согласно алгоритму,
// определенному на уровне прикладного решения
// 
// Параметры:
//  Номенклатура - ОпределяемыйТип.НоменклатураБЭД
//  Характеристика - ОпределяемыйТип.ХарактеристикаНоменклатурыБЭД
//  ИдентификаторФормы - УникальныйИдентификатор - уникальный идентификатор формы,  в КЭШ которой 
//  												необходимо сохранить полученную таблицу изображений
// 
// Возвращаемое значение:
...
Функция ПодобранноеИзображениеТовараЗКП(Номенклатура, Характеристика, ИдентификаторФормы) Экспорт
	...
	ТаблицаИзображений = ТаблицаПодобранныхИзображенийДляПубликацииВЗКП(Номенклатура, Характеристика);
...
// Возвращает таблицу подобранных изображений, прошедших валидацию и отсортированных, 
// 	доступных для выбора в документ ЗКП для дальнейшей публикации.
// 
// Параметры:
//  Номенклатура - ОпределяемыйТип.НоменклатураБЭД
//  Характеристика - ОпределяемыйТип.ХарактеристикаНоменклатурыБЭД
...
Функция ТаблицаПодобранныхИзображенийДляПубликацииВЗКП(Номенклатура, Характеристика) Экспорт
		
	ПараметрыПодбора = НовыеПараметрыПодбораИзображенийВЗКП(Номенклатура, Характеристика);
...
Функция ОшибкиВалидацииИзображенийТаблицы(ТаблицаИзображений) Экспорт
	...
	Для Каждого Строка Из ТаблицаИзображений Цикл
		...
		ИначеЕсли Не ОбщегоНазначения.СсылкаСуществует(Строка.Изображение) 
...
// * Номенклатура - ОпределяемыйТип.НоменклатураБЭД
// * Характеристика - ОпределяемыйТип.ХарактеристикаНоменклатурыБЭД 
Функция НовыеПараметрыПодбораИзображенийВЗКП(Номенклатура, Характеристика) Экспорт

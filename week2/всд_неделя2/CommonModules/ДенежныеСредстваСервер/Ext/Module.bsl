...
// Проверяет и заполняет реквизит НаправлениеДеятельности в документе оплаты.
//
// Параметры:
//  ДокументОбъект  - ДанныеФормыСтруктура - документ, в котором выполняется заполнение.
//  НаправлениеДеятельности - СправочникСсылка.НаправленияДеятельности - проверяемое и заполняемое значение.
//  ОчиститьЗначение - Булево - признак очистки реквизита, если соответствующая настройка не включена.
//
Процедура ПроверитьЗаполнитьНаправлениеДеятельности(ДокументОбъект, НаправлениеДеятельности) Экспорт
	...
	ИначеЕсли ДокументОбъект.ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ВозвратОплатыКлиенту
	...
	Если ЗначениеЗаполнено(НаправлениеДеятельности)
		...
		ДокументОбъект.НаправлениеДеятельности = НаправлениеДеятельности;
	Иначе
		ДокументОбъект.НаправлениеДеятельности = Справочники.НаправленияДеятельности.ПустаяСсылка();
	КонецЕсли;
...
Процедура ЗаполнитьДанныеФормыДокументаПоДоговору(Форма, РеквизитыДоговора) Экспорт
	...
	ДенежныеСредстваСервер.ПроверитьЗаполнитьНаправлениеДеятельности(Объект, РеквизитыДоговора.НаправлениеДеятельности);

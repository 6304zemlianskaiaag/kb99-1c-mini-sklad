...
// 	- Массив из Структура см. РаспаковатьАрхивСИзменениемИменФайлов
...
Функция БуферИмениИзСоответствия(БуферИмени, СоответствиеИменФайлов)
	...
	Для Каждого Кодировка Из ВозможныеКодировки Цикл
		...
		ИменаВКодировках.Добавить(СтрЗаменить(ИмяФайлаВКодировке, "/", "\"));
		ИменаВКодировках.Добавить(СтрЗаменить(ИмяФайлаВКодировке, "\", "/"));
	КонецЦикла;
	...
	КонецЦикла;
	Если ДанныеФайла = Неопределено Тогда
		ВызватьИсключение (НСтр("ru = 'Ошибка разбора кодировки имени файла транпортного контейнера'"));
	КонецЕсли;

...
//++ Локализация
	...
	ЗаполнениеИзФормыПодбора = ТипЗнч(ШтрихкодыУпаковок) = Тип("ТаблицаЗначений")
		И ШтрихкодыУпаковок.Колонки.Найти("ИзОрдера")<> Неопределено;
	...
	Для Каждого Строка Из Товары Цикл
		...
		Для каждого Марка Из НайденныеОтгруженныеМарки Цикл
			...
			Если ЗаполнениеИзФормыПодбора Тогда

...
Функция ПредставленияДоверителейИПредставителей(Доверенности) Экспорт
	...
	Для Каждого КлючЗначение Из ДоверителиПредставители Цикл
		...
		ПредставленияДоверителейПредставителей.Доверители = ПредставленияСубьектовДоверенности(
			ДоверителиПредставителиДоверенности.Доверители);
			
		ПредставленияДоверителейПредставителей.Представители = ПредставленияСубьектовДоверенности(
...
// Возвращаемое значение:
//  Дата
Функция ДатаОтзываМЧДПоДаннымРеестраФНС(НомерДоверенности, ТокенДоступа) Экспорт
...
// Возвращаемое значение:
//  Массив из Строка
Функция ПредставленияСубьектовДоверенности(ДанныеСубъекта)
	ПредставленияСубьектовДоверенности = Новый Массив;
	Для Каждого Субъект Из ДанныеСубъекта Цикл
		ПредставленияСубьектовДоверенности.Добавить(ПредставлениеСубъектаДоверенности(Субъект));
	КонецЦикла;
	Возврат ПредставленияСубьектовДоверенности;
КонецФункции

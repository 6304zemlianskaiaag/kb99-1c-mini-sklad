...
//
Функция НавигационнаяСсылкаНаТоварВСписке(ИдентификаторПубликации) Экспорт

	Возврат СтрШаблон("https://seller.ozon.ru/app/products?search=%1", ИдентификаторПубликации);

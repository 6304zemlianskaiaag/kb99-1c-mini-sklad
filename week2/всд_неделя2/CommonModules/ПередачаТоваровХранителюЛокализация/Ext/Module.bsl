...
Процедура ПоместитьВременнуюТаблицуТоваров(МенеджерВременныхТаблиц, ПараметрыЗаполнения = Неопределено) Экспорт
	...
	|ИЗ
	|	Документ.ПередачаТоваровХранителю КАК Таблица
	|ВНУТРЕННЕЕ СОЕДИНЕНИЕ
	|	ТаблицаДанныхДокументов КАК ДанныеДокументов
	|ПО
	|	Таблица.Ссылка = ДанныеДокументов.Ссылка
	|	ИЛИ Таблица.ИсправляемыйДокумент = ДанныеДокументов.Ссылка.ИсправляемыйДокумент
	|	ИЛИ Таблица.Ссылка = ДанныеДокументов.Ссылка.ИсправляемыйДокумент
	|ГДЕ
	|	Таблица.Проведен
	|;
	|////////////////////////////////////////////////////////////////////////////////

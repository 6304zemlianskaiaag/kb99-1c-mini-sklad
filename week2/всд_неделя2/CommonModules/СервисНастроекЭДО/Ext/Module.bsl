...
// Возвращаемое значение:
//  Строка
Функция ТекстЗапросаКодОшибкиНедействительныхСертификатов() Экспорт
...
// Возвращаемое значение:
//  РезультатЗапроса
Функция РезультатЗапросаКодОшибкиНедействительныхСертификатов(ИдентификаторОператора) Экспорт

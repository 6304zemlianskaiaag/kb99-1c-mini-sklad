...
Функция ВидОплатыНаТерминалеПоКоду(ВидОплатыКод) Экспорт  
	...
	Соответствие = Перечисления.ВидОплатыНаТерминале.ВидОплатыНаТерминалеПоКоду();
	Возврат Соответствие.Получить(ВидОплатыКод);
...
Функция КодВидаОплатыНаТерминале(ВидОплаты) Экспорт
	...
	Соответствие = Перечисления.ВидОплатыНаТерминале.КодВидаОплатыНаТерминале();
	Возврат Соответствие.Получить(ВидОплаты);

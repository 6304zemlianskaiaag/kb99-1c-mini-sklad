...
Процедура НайтиСоздатьСчетНаОплату_5_01(ДеревоДанных, ДокументУчета = Неопределено, СпособОбработки = "", ОписаниеОшибки = "") Экспорт
	...
	//++ НЕ ГОСИС
	ОбменСКонтрагентамиУТ.НайтиСоздатьСчетНаОплату_5_01(ДеревоДанных, ДокументУчета, СпособОбработки, ОписаниеОшибки);
	//-- НЕ ГОСИС
...
Процедура ПриОпределенииПараметровФайлаПрикладногоЭлектронногоДокумента(ДанныеФайла, РасширениеФайла, Параметры) Экспорт
	...
	ИнтеграцияСМаркетплейсамиСервер.ПриОпределенииПараметровФайлаПрикладногоЭлектронногоДокумента(ДанныеФайла, 
		РасширениеФайла, 
		Параметры);
...
Процедура ПриЗаполненииТабличногоДокументаИзФайлаПрикладногоЭлектронногоДокумента(ТабличныйДокумент, ДанныеФайла, ПараметрыЗаполнения) Экспорт
	...
	// ИнтеграцияСМаркетплейсами
	ИнтеграцияСМаркетплейсамиСервер.ПриЗаполненииТабличногоДокументаИзФайлаПрикладногоЭлектронногоДокумента(ТабличныйДокумент, 
		ДанныеФайла, 
		ПараметрыЗаполнения);
	// Конец ИнтеграцияСМаркетплейсами
...
//
Процедура ПриПроверкиГотовностиЭлектронногоДокумента(ТолькоПросмотр) Экспорт

КонецПроцедуры

#КонецОбласти

// Если Результат = Истина, то УПД и УКД отражаются одним документом, иначе - 2-умя
// 
// Параметры:
//  Результат - Булево
//

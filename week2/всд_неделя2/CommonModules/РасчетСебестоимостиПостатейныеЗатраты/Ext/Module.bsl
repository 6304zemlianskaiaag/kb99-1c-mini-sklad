...
Функция ПоказателиБазыРаспределенияПриемниковПрошлыхПериодов()
	...
	ТекстЗапросаПоказателиБазыРаспределенияПриемниковПрошлыхПериодов = "
		...
		|			И (Источник.Организация					= ВыбытиеДетально.Организация
		|				ИЛИ ВыбытиеДетально.Партия <> НЕОПРЕДЕЛЕНО)
		|ГДЕ
...
Функция ТекстДолиДополнительныхРасходов()
	...
	ТекстЗапроса =
		...
		|		ИНАЧЕ ПриемникиПоТоварам.ВидДеятельностиНДС КОНЕЦ) КАК КорВидДеятельностиНДС,

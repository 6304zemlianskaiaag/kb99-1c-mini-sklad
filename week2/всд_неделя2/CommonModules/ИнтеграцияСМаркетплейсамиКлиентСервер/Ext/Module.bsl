...
//   ПостфиксOzon    - Строка - постфикс картинки Ozon.
//   ПостфиксWB      - Строка - постфикс картинки Wildberries.
//   ПостфиксЯМ      - Строка - постфикс картинки Яндекс Маркет.
//
// Возвращаемое значение:
//   Картинка - логотип.
//
Функция ЛоготипТорговойПлощадки(ВидМаркетплейса, Знач ПостфиксOzon = "2", Знач ПостфиксWB = "", Знач ПостфиксЯМ = "") Экспорт

	Если ВидМаркетплейса = ПредопределенноеЗначение("Перечисление.ВидыМаркетплейсов.МаркетплейсOzon") Тогда
		Логотип  = БиблиотекаКартинок["ЛоготипOzon" + ПостфиксOzon];
	ИначеЕсли ВидМаркетплейса = ПредопределенноеЗначение("Перечисление.ВидыМаркетплейсов.МаркетплейсWildberries") Тогда
		Логотип = БиблиотекаКартинок["ЛоготипWildberries" + ПостфиксWB];
	ИначеЕсли ВидМаркетплейса = ПредопределенноеЗначение("Перечисление.ВидыМаркетплейсов.МаркетплейсЯндексМаркет") Тогда
		Логотип = БиблиотекаКартинок["ЛоготипЯндексМаркет" + ПостфиксЯМ];
	Иначе

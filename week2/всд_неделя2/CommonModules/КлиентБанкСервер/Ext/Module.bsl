...
Процедура ЗаполнитьСтрокуРасшифровкиПлатежаПоОбъектуРасчета(
	...
	ЗаполнитьЗначенияСвойств(СтрокаРасшифровки, ДанныеОбъектаРасчета, , "Сумма");
...
Процедура ЗаполнитьРеквизитыСписания(ДокументыКЗагрузке, СтрокаДокумента, ДокументОбъект, СоздаватьКонтрагентов, ПроводитьДокументы, Префикс)
	...
	КлиентБанкЛокализация.ЗаполнитьРеквизитыСписания(СтрокаДокумента, ДокументОбъект);
...
Процедура ЗаполнитьРеквизитыПоступления(ДокументыКЗагрузке, СтрокаДокумента, ДокументОбъект, СоздаватьКонтрагентов, ПроводитьДокументы)
	...
	Если РеквизитыХозОперации.Найти("ДоговорЭквайринга") <> Неопределено Тогда
		...
		Иначе
			...
			КонецЕсли;
		КонецЕсли;
		КлиентБанкЛокализация.ЗаполнитьСуммуКомиссии(ДокументОбъект, РеквизитыДоговора, ОбработатьКомиссию);
	КонецЕсли;

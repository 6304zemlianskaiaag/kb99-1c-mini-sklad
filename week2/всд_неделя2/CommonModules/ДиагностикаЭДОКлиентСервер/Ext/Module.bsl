...
//  Структура:
//  * Идентификатор - Строка
//  * ОтправкаПолучениеВыполнялись - Булево
//  * ПользовательОтказалсяОтОперации - Булево
//  * ИнформацияОбОшибке - см. НоваяИнформацияОбОшибке
...
//  * ПодробноеПредставление - Структура:
//    ** Текст - Строка

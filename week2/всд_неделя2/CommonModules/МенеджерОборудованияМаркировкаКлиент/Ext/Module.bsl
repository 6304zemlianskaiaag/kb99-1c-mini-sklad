...
Функция КодПланируемыйСтатусМаркируемогоТовара(ПланируемыйСтатусМаркируемогоТовара) Экспорт
	...
	Соответствие = КлассификаторыБиблиотеки.КодыПланируемыхСтатусовМаркируемогоТовара;
...
Функция КодОтветаОИСМОСтатусеТовара(ОтветОИСМОСтатусеТовара) Экспорт
	...
	КлассификаторыБиблиотеки = МенеджерОборудованияКлиент.КлассификаторыБиблиотеки();
	Соответствие = КлассификаторыБиблиотеки.КодыОтветаОИСМОСтатусеТовара;
...
Функция ОтветОИСМОСтатусеТовараПоКоду(ОтветОИСМОСтатусеТовара) Экспорт
	...
	КлассификаторыБиблиотеки = МенеджерОборудованияКлиент.КлассификаторыБиблиотеки();
	Соответствие = КлассификаторыБиблиотеки.ОтветыОИСМОСтатусеТовараПоКоду;
	Возврат Соответствие.Получить(ОтветОИСМОСтатусеТовара);

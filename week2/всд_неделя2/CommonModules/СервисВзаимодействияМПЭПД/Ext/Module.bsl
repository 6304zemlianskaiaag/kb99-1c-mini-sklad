...
Функция СервисДобавитьВодителя(ИдентификаторЭДО, ДанныеВодителя) Экспорт
	...
	Если ОтветСервиса.Успех Тогда
		...
		НоваяЗапись.СерияВУ = СвойствоСтруктуры(ДанныеВодителя, "СерияВУ");
		НоваяЗапись.НомерВУ = СвойствоСтруктуры(ДанныеВодителя, "НомерВУ");
		НоваяЗапись.ДатаВыдачиВУ = СвойствоСтруктуры(ДанныеВодителя, "ДатаВыдачиВУ");
		...
		Если ОтветСервиса.Успех Тогда
			...
			Для Каждого СтрокаМассива Из ДанныеОтвета Цикл
				...
				Если СтруктураВУ <> Неопределено Тогда
					...
					НоваяЗапись.ДатаВыдачиВУ = СтруктураВУ["Date"];
				КонецЕсли;

...
Функция ТекущееСостояниеПисемСБанками() Экспорт  		
	...
	|	КОЛИЧЕСТВО(ПисьмоОбменСБанками.Ссылка) КАК КоличествоНепрочитанных
	|ИЗ
	...
	Пока ВыборкаБанков.Следующий() Цикл
		...
		КоличествоНепрочитанных = ВыборкаНепрочитанных.КоличествоНепрочитанных;
		ВсегоНепрочитанных = ВсегоНепрочитанных+КоличествоНепрочитанных;
		
		СведенияОНепрочитанных = Новый Структура;
		СведенияОНепрочитанных.Вставить("Банк",ВыборкаБанков.Банк);
		СведенияОНепрочитанных.Вставить("Количество", КоличествоНепрочитанных);
	...
	СведенияОНастройке.Вставить("КоличествоНепрочитанных", ВсегоНепрочитанных);

...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СертификатСписокВыбора = Неопределено;
	...
	Если СертификатСписокВыбора.Количество() = 0 Тогда
		СертификатСписокВыбора.Добавить("СертификатыЗагружаются", 
			НСтр("ru = 'Сертификаты загружаются, откройте список повторно через 5 с.'"));
	КонецЕсли;
...
&НаКлиенте
Процедура СертификатСмешанныйОбработкаВыбора(Элемент, ВыбранноеЗначение, ДополнительныеДанные, СтандартнаяОбработка)
...
&НаКлиенте
Процедура СертификатСмешанныйУНОбработкаВыбора(Элемент, ВыбранноеЗначение, ДополнительныеДанные, СтандартнаяОбработка)
	Если ВыбранноеЗначение = "СертификатыЗагружаются" Тогда
		СтандартнаяОбработка = Ложь;
		Возврат;
	КонецЕсли;

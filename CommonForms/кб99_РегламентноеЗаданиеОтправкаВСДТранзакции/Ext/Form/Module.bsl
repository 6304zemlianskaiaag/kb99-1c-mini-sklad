...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Действие = "Добавить" Тогда
		...
		//ЗависимостиЗаданий     = ВетИС_РегламентныеЗаданияСервер.РегламентныеЗаданияЗависимыеОтФункциональныхОпций();
		//
...
Процедура ПриОткрытии(Отказ)
	...
	Если Действие = "Добавить" Тогда
		...
		ИмяМетодаМетаданных = "ВетИС_РегламентныеЗаданияСервер.кб99_ОтложеннаяОтправкаВСД2Транзакции";

...
Функция ЗаполнитьТчСписаниеИзСпецификацииНоменклатуры( Знач Параметры, тзНоменклатуры ) Экспорт
	...
	ПереопределенныйМодуль = кб99_ВСД_Утилиты.ФункцияПереопределена("ЗаполнитьТчСписаниеИзСпецификацииНоменклатуры");
...
Функция ПолучитьНомерПартии( Знач ПараметрыОрганизации, СтрокаТчДок ) Экспорт
	...
	// вызов переопределения
	ПереопределенныйМодуль = кб99_ВСД_Утилиты.ФункцияПереопределена("ПолучитьНомерПартии");
	Если ПереопределенныйМодуль <> Неопределено Тогда
...
Функция ПолучитьНомерНезавершенногоПроизводства(ПараметрыОрганизации, СтрокаТЧ) Экспорт
	...
	// вызов переопределения
	ПереопределенныйМодуль = кб99_ВСД_Утилиты.ФункцияПереопределена("ПолучитьНомерНезавершенногоПроизводства");
	Если ПереопределенныйМодуль <> Неопределено Тогда
	...
	Артикул = кб99_ВСД_ЗаполнениеДокументов.ПолучитьАртикулНоменклатуры(ПараметрыОрганизации, СтрокаТЧ, "", "");
...
Функция ОформитьПроизводствоПострочно(ПараметрыОрганизации, ДокументОснование) Экспорт
	...
	ТЗ = кб99_ВСД_ЗаполнениеДокументов.ВыгрузитьТЧ(ДокументОснование, ПараметрыОрганизации);

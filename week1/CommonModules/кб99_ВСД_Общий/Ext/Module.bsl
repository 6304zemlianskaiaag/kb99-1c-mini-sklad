...
//
// кб99_ВСД_ЗаполнениеДокументов (7 функций):
...
//
// кб99_ВСД_Гашение (2 функции):
//   - Гашение_НайтиДокументПоступлениеТоваров
//   - ФормироватьДвиженияПартий
//
// Функции ниже помечены @Deprecated и оставлены для обратной совместимости.
// Рекомендуется обновить вызовы на новые модули.
//
// ========================================================================

#КонецОбласти

#Область УстаревшиеФункции_ИспользуйтеНовыеМодули

// @Deprecated Используйте кб99_ВСД_Утилиты.СтрРазделить82()
...
// @Deprecated Используйте кб99_ВСД_Утилиты.СерверныйМодульМенеджера()
...
// @Deprecated Используйте кб99_ВСД_Утилиты.ОбщийМодуль()
...
// @Deprecated Используйте кб99_ВСД_Параметры.ПолучитьОрганизациюПоУмолчанию()
...
// @Deprecated Используйте кб99_ВСД_Параметры.ПараметрыСервер()
...
// @Deprecated Используйте кб99_ВСД_Утилиты.СообщенияПользователю()
...
// @Deprecated Используйте кб99_ВСД_Утилиты.ОпределитьТипОбъектаМетаданных()
...
// @Deprecated Используйте кб99_ВСД_Утилиты.ПолучитьНомерДокБезПрефикса()
...
// @Deprecated Используйте кб99_ВСД_Утилиты.ПолучитьНомерАвто()
...
// @Deprecated Используйте кб99_ВСД_ЗаполнениеДокументов.ЗаполнитьСвязанныеДокументы()
...
// @Deprecated Используйте кб99_ВСД_ЗаполнениеДокументов.РассчитатьКоличествоДляВСД()
...
// @Deprecated Используйте кб99_ВСД_ЗаполнениеДокументов.ВыгрузитьТч()
...
//				Если СтрТЧ.Упаковки <> 0 Тогда
//					СтрТЧ.Коэффициент = СтрТЧ.Количество / СтрТЧ.Упаковки;
//				Иначе
//					СтрТЧ.Коэффициент = 1;
//					кб99_ВСД.СообщитьИнфо("Количество упаковок равно нулю для " + стрДок.Номенклатура);
//				КонецЕсли;
//			Иначе
...
// @Deprecated Используйте кб99_ВСД_ЗаполнениеДокументов.ПолучитьАртикулНоменклатуры()
...
// @Deprecated Используйте кб99_ВСД_ЗаполнениеДокументов.ЗаполнитьРеквизитыСтрокиВСД()
...
// @Deprecated Используйте кб99_ВСД_ЗаполнениеДокументов.ЗаполнитьТабЧастьВСД()
...
// @Deprecated Используйте кб99_ВСД_ЗаполнениеДокументов.ЗаполнитьТабЧастьВСДпоТЗ()
// Заполняет ТЧ документа ВСД по Входящим данным , вызывается из ЗаполнитьНаосновании ВСД2_Транзакция
// ДанныеЗаполнения = Документ основание, берем из него ТЧ для расчета Кол-ва и Продэлементы для фильтра партий,
// также данные для заполнения Маркировок
...
// @Deprecated Используйте кб99_ВСД_ЗаполнениеДокументов.ЗаполнитьКорректировочныйВСД()
...
// @Deprecated Используйте кб99_ВСД_ЗаполнениеДокументов.РассчитатьКоличествоПотребительскихУпаковок()
...
//	Коэфф = 1; // Инициализация по умолчанию для предотвращения деления на ноль
//	
//	Если Не ЗначениеЗаполнено(Номенклатура) Тогда
//		кб99_ВСД.СообщитьИнфо("Коэффициент пересчета равен нулю, используется значение 1");
...
// @Deprecated Используйте кб99_ВСД_Утилиты.ФункцияПереопределена()
...
#КонецОбласти // УстаревшиеФункции_ИспользуйтеНовыеМодули
...
Функция ПолучитьТзРеализаций( ПараметрыФункции ) Экспорт
	...
	ПереопределенныйМодуль = кб99_ВСД_Утилиты.ФункцияПереопределена("ПолучитьТзРеализаций");
	Если ПереопределенныйМодуль <> Неопределено Тогда		
...
Функция СформироватьЗапросПеремещения( ПараметрыФункции ) Экспорт
	...
	ПереопределенныйМодуль = кб99_ВСД_Утилиты.ФункцияПереопределена("СформироватьЗапросПеремещения");
	Если ПереопределенныйМодуль <> Неопределено Тогда
...
// @Deprecated Используйте кб99_ВСД_Утилиты.НайтиApplicationID()
...
// @Deprecated Используйте кб99_ВСД_Утилиты.НайтиПоследнийЗапрос()
...
// @Deprecated Используйте кб99_ВСД_Утилиты.ПроверитьВладельцаСправочника()
...
// @Deprecated Используйте кб99_ВСД_Гашение.Гашение_НайтиДокументПоступлениеТоваров()
...
// @Deprecated Используйте кб99_ВСД_Гашение.ГашениеПроверитьСтрокуТаблицы()
...
// @Deprecated Используйте кб99_ВСД_Параметры.ПроверитьЗначениеПараметра()
...
// @Deprecated Используйте кб99_ВСД_Гашение.ФормироватьДвиженияПартий()
...
Процедура ОбработкаУдаленияПроведения(Отказ, Документ) Экспорт
	...
	ПоследнийЗапрос = кб99_ВСД_Утилиты.НайтиПоследнийЗапрос( Документ.Ссылка );
	Если кб99_ВСД_Гашение.ФормироватьДвиженияПартий(Документ.Организация) И ПоследнийЗапрос.СтатусЗапроса = "COMPLETED" Тогда
		//Отказ = Истина;
...
// @Deprecated Используйте кб99_ВСД_Утилиты.ЕстьРеквизитИлиСвойствоОбъекта()
...
// @Deprecated Используйте кб99_ВСД_Утилиты.СвернутьМассив()
...
// @Deprecated Используйте кб99_ВСД_Утилиты.СтрокаИзМассиваПодстрок()
...
// @Deprecated Используйте кб99_ВСД_Утилиты.ПредставлениеПериодаВЕТИС()
...
// @Deprecated Используйте кб99_ВСД_Утилиты.ОписаниеВерсии()
...
// @Deprecated Используйте кб99_ВСД_Параметры.ПолучитьТекущегоПользователя()
...
// @Deprecated Используйте кб99_ВСД_Утилиты.ЭтоДокументОтгрузка()
...
// @Deprecated Используйте кб99_ВСД_Утилиты.ЭтоДокументПеремещение()
...
Функция ПолучитьПредставлениеПолейДокументаВЗапрос() Экспорт
	...
	ПереопределенныйМодуль = кб99_ВСД_Утилиты.ФункцияПереопределена("ПолучитьПредставлениеПолейДокументаВЗапрос");
	Если ПереопределенныйМодуль <> Неопределено Тогда
...
Процедура УстановитьПараметрПлощадкаОтправителяСклад(Запрос, ПараметрыФункции) Экспорт
	...
	Попытка
		...
		Если (НЕ ЗначениеЗаполнено(ПараметрыФункции["ПлощадкаОтправителя"].Склад)) 
			...
			кб99_ВСД.СообщитьИнфо("Не определен Склад по Площадке " + ПараметрыФункции["ПлощадкаОтправителя"] 
...
// @Deprecated Используйте кб99_ВСД_Параметры.ЭтоПолноправныйПользователь()

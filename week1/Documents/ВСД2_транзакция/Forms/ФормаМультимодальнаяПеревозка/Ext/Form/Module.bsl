...
Процедура ГородПриИзменении(Элемент)
	...
	Если Не кб99_ВСД_Утилиты.ПроверитьВладельцаСправочника(Город, Владелец_) Тогда
		Город = Неопределено;
	КонецЕсли;
...
Процедура УлицаПриИзменении(Элемент)
	...
	Если Не кб99_ВСД_Утилиты.ПроверитьВладельцаСправочника(Улица, Владелец_) Тогда
		Улица = Неопределено;
	КонецЕсли;

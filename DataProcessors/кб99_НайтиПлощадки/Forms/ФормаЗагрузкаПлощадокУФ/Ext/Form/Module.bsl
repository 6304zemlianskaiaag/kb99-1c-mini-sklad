...
// @grace-purpose: Форма поиска и загрузки площадок ВетИС по хозяйствующему субъекту/региону
...
Процедура кнВыполнитьПоискСервер(СписокУсловий)
	...
	МассивПлощадок = ВетИС_APIСервер.Площадки_ЗагрузитьПоУсловиям(ПараметрыОрганизации, СписокУсловий);
...
&НаКлиенте
// @grace-contract: кнСохранитьОтвет
//   Вход: см. сигнатуру
//   Выход: нет
//   Исключение: нет
//   Инвариант: нет
//   GRACE-лог: нет
// GRACE:CONTRACT function="кнСохранитьОтвет"
